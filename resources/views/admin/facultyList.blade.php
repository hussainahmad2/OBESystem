...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 mt-4">
            @if(session('success'))
                <div class="alert alert-success" style="background:#d4edda; color:#155724; border:1px solid #c3e6cb; border-radius:6px; font-weight:500; margin-bottom:18px;">
                    {{ session('success') }}
                </div>
            @endif
            ...
            <div class="search d-flex justify-content-between">
                ...
                <form method="GET" action="{{ route('faculty.list') }}" class="search-container" onsubmit="return false;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; gap: 6px; justify-content: center;">
                                        <a href="{{ route('edit.faculty', $facultie->id) }}" class="btn btn-primary btn-sm">Edit</a>
