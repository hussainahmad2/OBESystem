    ...
    <div class="row">
        ...
        <div class="col-md-9 col-lg-10 mt-4">
            ...
            <div class="search d-flex justify-content-between">
                <h2 class="textnone">Student List</h2>
                <form method="GET" action="{{ route('student.list') }}" class="search-container" onsubmit="return false;">
                    <input type="text" id="student-search" name="search" placeholder="Search Student..." value="{{ request('search') }}" autocomplete="off" />
                    ...
                    <tbody>
                        @foreach($students as $student)
                            <tr>
                                ...
                                <td>{{ strtoupper($student->batch) }}</td>
                                <td>{{ strtoupper($student->section) }}</td>
