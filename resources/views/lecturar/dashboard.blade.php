                        ...
                        <tbody>
                            @forelse($CourseAllocations as $Course)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-sm" href="{{ route('courses.AllRegisteredStudent', $Course->course_id) }}">View All</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                ...
                                <tbody>
                                    @foreach($students as $student)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('student.marks', $student->id) }}" class="btn btn-info btn-sm">View Marks</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
