    ...
    <div class="row m-0" >
        ...
        <div class="col-md-9 col-lg-10 d-flex justify-content-center align-items-start main-div">
            <div style="width:100%; max-width:600px; position:relative;">
                <a href="{{ route('QualityEnhancementCell.list') }}" title="Back to QEC List" style="position:absolute; top:16px; left:-220px; font-size:22px; color:#23546B; background:none; border:none; padding:0; cursor:pointer; z-index:2;">
